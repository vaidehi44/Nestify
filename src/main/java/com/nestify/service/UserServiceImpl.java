...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public void updateProfile(ProfileUpdateRequestDto profileUpdateRequestDto) {
        ...
        if (profileUpdateRequestDto.getFirstName() != null) user.setFirstName((profileUpdateRequestDto.getFirstName()));
        if (profileUpdateRequestDto.getLastName() != null) user.setLastName((profileUpdateRequestDto.getLastName()));
