...
import com.nestify.repository.GuestRepository;
...
public class GuestServiceImpl implements GuestService {
    ...
    public void updateGuest(Long guestId, GuestDto guestDto) {
        ...
        User user = getCurrentUser();
        if(!user.equals(guest.getUser())) throw new AccessDeniedException("The logged in user is not the owner of this guest");
